...
void main()
{
	v_TexturePosition1 = a_TexturePosition * 1.0;
	v_TexturePosition2 = a_TexturePosition * 2.0;
	v_TexturePosition4 = a_TexturePosition * 4.0;

	v_CloudsColor0 = a_CloudsColor0;
	v_CloudsColor1 = a_CloudsColor1;
