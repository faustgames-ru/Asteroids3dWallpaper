...
public class EffectPostProcessBlurV extends EffectPostProcess {
    public EffectPostProcessBlurV() {
        super("", "",
                new String[]{
                        "u_Image",
                        "u_TexelSize"
    ...
    public void onCreate(Context context) {
        ...
        setCode(
                loadFromRaw(context, R.raw.effect_postprocess_blur_v_vertex),
                loadFromRaw(context, R.raw.effect_postprocess_blur_v_fragment));
    }
