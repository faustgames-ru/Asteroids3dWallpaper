...
public class EffectSkyBoxProceduralSimple  extends Effect {
    public EffectSkyBoxProceduralSimple() {
        super(
                "", "",
    ...
    public void onCreate(Context context) {
        ...
        setCode(
                loadFromRaw(context, R.raw.effect_skybox_procedural_simple_vertex),
                loadFromRaw(context, R.raw.effect_skybox_procedural_simple_fragment));
    }
